    ...
    >
      <div className="navbar">
        <div className="navbar-start">
          ...
          <Link to="/" className="text-2xl cursor-pointer font-bold">
            BookStore
          </Link>
        </div>
        <div className="navbar-end space-x-3">
          ...
          <div>
            <a
              className="cursor-pointer bg-black text-white hover:bg-slate-800 duration-300 rounded-md px-3 py-2"
              onClick={() => showModal("my_modal_1")}
            >
              Login
            </a>

            <Login showSignup={showModal} closeModal={closeModal} />
            <Signup showLogin={showModal} closeModal={closeModal} />
          </div>
        </div>
      </div>
    </div>
